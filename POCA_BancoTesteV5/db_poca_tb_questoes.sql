...
INSERT INTO `tb_questoes` VALUES (1,'Este é um teste?','Sim.','Não!','Chute errado.','Também não!','Fácil','Teoria'),(2,'Este é um teste?','Sim.','Não!','Chute errado.','Também não!','Médio','Programação'),(3,'O que é uma variável?','Espaço na memória para armazenar valores','Uma função','Um operador','Um tipo de dado','Fácil','Teoria'),(4,'Qual comando imprime na tela em Python?','print()','input()','echo','scanf','Fácil','Programação'),(5,'Qual estrutura representa uma repetição?','Laço','Função','Classe','Vetor','Médio','Teoria');
...
-- Dump completed on 2025-05-31 12:59:11
